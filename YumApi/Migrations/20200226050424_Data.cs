        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CartIngredient_Unit_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Unit",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CartIngredientId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ingredient_CartIngredient_CartIngredientId",
                        column: x => x.CartIngredientId,
                        principalTable: "CartIngredient",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Role",
                columns: new[] { "Id", "RoleName" },
                values: new object[] { 3, "Blogger" });

            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "Id", "Email", "Password", "RoleId", "UserProfileId", "Username" },
                values: new object[] { 1, "admin@admin.com", "admin", 1, 0, "AdminUser" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ingredient_CartIngredientId",
                table: "Ingredient",
                column: "CartIngredientId");
